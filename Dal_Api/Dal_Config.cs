...
&lt;/config&gt;<br/>
    ...
    */
    static class Dal_Config
    {
        public class Dal_Package
        {
            public string Name;
        ...
        internal static string Dal_Name;
        internal static Dictionary<string, Dal_Package> Dal_Packages;
    ...
    /// </summary>
    [Serializable]
    public class Dal_ConfigException : Exception
    {
        public Dal_ConfigException(string message) : base(message) { }
        public Dal_ConfigException(string message, Exception inner) : base(message, inner) { }
    }
